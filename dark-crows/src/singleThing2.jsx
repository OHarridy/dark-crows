...
export default function singleThing2() {
    var [fna] = useState(
        [
    ...
    return (
        <ul className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            {fna.map(fn => (
                <div id={"fn" + fn.id} className="fn-preview " key={fn.id}>
                    <a href="/DonationPage" rel="noopener noreferrer">
                        <Card
                            ...
                            <CardHeader className="justify-between pb-0">
                                ...
                                <h1 className="text-medium font-semibold leading-none text-default-900 mr-auto">{fn.author}</h1>
                            </CardHeader>
                            ...
                            <Progress
                                ...
                                label={fn.maximumAmount + " requested"}
                                valueLabel={fn.donatedAmount / fn.maximumAmount * 100 + "%"}
                                showValueLabel={true}
                                ...
                                maxValue={fn.maximumAmount} 
                                value={fn.donatedAmount}/>
                            <CardFooter className="py-0 mx-0 px-1.5">
                                <div className="flex gap-1 p-0 my-auto mx-0">
                                    ...
                                    <h1 className="font-semibold p-0 mx-0 my-1 text-default-400 text-small">{fn.donatorCount}</h1>
