...
function Card(donor){
    ...
    return (
        <div className="card m-2 cursor-pointer flex-col justify-between" style={{display:hidden}}>
           
            <span className="pt-3">{donor.name}</span>
            <p className="info hidden">{donor.email}</p>
            <p className="info">{donor.number}</p>
            ...
            <button onClick={setHide} className="buttonCard" height='35px' width='80px' >Delete</button>
